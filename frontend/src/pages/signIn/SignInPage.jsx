...
//             {/* Remaining social media icons code */}
//           </div>
//         </div>
//       </div>
//     );
...
const SignInPage = () => {
    return (
      <div className="form-container">
        ...
        {/* <Divide orientation="vertical" variant="middle" flexItem /> */}

        <div className="divider"></div>
        <br/>
        <div className="right-form">
            <h2>Benefits of your free ReelHive account</h2>
            <br/>
            ...
            <p className="paragraph">
                <strong>Contribute to ReelHive</strong>
                <br/>
